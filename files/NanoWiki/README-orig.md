...
<p style="text-align: center"><img src="$config.app_url$/static/screenshot.jpg" alt="Screenshot of the main page of PicoWiki"></p>
...
<img src="$config.app_url$/static/screenshot-code.jpg" alt="Screenshot of the code of PicoWiki where you can see that it is less than 100 lines of code">
